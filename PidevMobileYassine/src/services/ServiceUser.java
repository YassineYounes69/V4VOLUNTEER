...
public class ServiceUser {
    ...
    public boolean addUser(User u) {
        ...
        String url = Statics.BASE_URL + "/users/createUser?username=" + username + "&email=" + email + "&password=" + pw + "&phoneNumber=" + phone+"&role="+u.getRole();  //création de l'URL
        ...
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            ...
            Body = "<h1>Hello " + uname + "!</h1>"
                    ...
                    + "<a href='http://127.0.0.1:8000/mobile/users/enableUser/"+idLastUser+"'>"+"Activate your account ! </a>";
        ...
        String urlMail = Statics.BASE_URL + "/users/sendMail?recipient=" + email + "&body=" + Body;
    ...
    public boolean verifyMailExistance(String mail){
        ...
        String url = Statics.BASE_URL + "/users/validateEmail?email=" + mail;  //création de l'URL
        System.out.println(url);
...
NetworkManager.getInstance().addToQueueAndWait(req3);
    ...
    public User login(String username,String pw){
        String url = Statics.BASE_URL + "/users/login?username="+username+"&pw="+pw;
    ...
    public boolean resetPw(String email){
        ...
        String url = Statics.BASE_URL + "/users/resetPw?pw="+pw+"&email="+email;
        System.out.println(url);
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    public boolean updateUN(String username,int id){
        ...
        String url = Statics.BASE_URL + "/users/updateUN?id="+id+"&username="+username;
    ...
    public boolean updatePW(String pw,int id){
        ...
        String url = Statics.BASE_URL + "/users/updatePw?id="+id+"&pw="+pw;
    ...
    public boolean updateEM(String em,int id){
        ...
        String url = Statics.BASE_URL + "/users/updateEM?id="+id+"&email="+em;
    ...
    public boolean updatePN(String pn,int id){
        ...
        String url = Statics.BASE_URL + "/users/updatePN?id="+id+"&tel="+pn;
    ...
    public boolean updatePRE(String pre,int id){
        ...
        String url = Statics.BASE_URL + "/users/updatePRE?id="+id+"&prenom="+pre;
    ...
    public boolean updateNOM(String nom,int id){
        ...
        String url = Statics.BASE_URL + "/users/updateNOM?id="+id+"&nom="+nom;
