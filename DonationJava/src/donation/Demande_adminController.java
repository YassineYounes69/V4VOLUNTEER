...
//            aff.setVisible(true);
            ...
            supprimer.setOnAction((ActionEvent en) -> {
                ...
                AnchorPane redirect;
                try {
                    redirect = FXMLLoader.load(getClass().getResource("Demande_admin.fxml"));
...
//        window.show();
    ...
    @FXML
    private void toDon(ActionEvent event) throws IOException {
        Parent tableViewParent = FXMLLoader.load(getClass().getResource("Donation_admin.fxml"));
        Scene tableViewScene = new Scene(tableViewParent);
