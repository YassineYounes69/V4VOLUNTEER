...
public class Refugies {
    ...
    public int hashCode() {
        ...
        hash = 97 * hash + this.id_membere;
        hash = 97 * hash + Objects.hashCode(this.pays_ref);
        hash = 97 * hash + Objects.hashCode(this.etat_ref);
        hash = 97 * hash + Objects.hashCode(this.nom_ref);
        hash = 97 * hash + Objects.hashCode(this.prenom_ref);
        hash = 97 * hash + this.age_ref;
        hash = 97 * hash + Objects.hashCode(this.gender_ref);
