...
public class Logement {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 19 * hash + this.nb__chambre;
        hash = 19 * hash + this.id_log;
        hash = 19 * hash + this.id_user;
        hash = 19 * hash + Objects.hashCode(this.adresse);
        hash = 19 * hash + Objects.hashCode(this.etat_log);
        hash = 19 * hash + this.id_ref;
        hash = 19 * hash + Objects.hashCode(this.nom_log);
        return hash;
    }
