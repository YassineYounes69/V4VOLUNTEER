...
class __TwigTemplate_ed80842c841fa6046bd8c2754d68c82337c298319e66228511691228fa5bf750 extends \Twig\Template
{
...
{% block content %}
    ...
    <head>
        <meta charset=\"UTF-8\"/>
        <title>{% block title %}Ajouter un Logement{% endblock %}</title>
    ...
    <form method=\"post\">
        ...
        <div align=\"center\">
            ...
            <button href=\"{{ path('project_AjouterLog') }}\" type=\"submit\" class=\"btn btn-primary btn-icon-text\" id=\"submit\"  > Ajouter </button>
...
{% endblock %}
", "@Project/Default/AjouterLog.html.twig", "C:\\wamp64\\www\\ProjetFIN\\src\\ProjectBundle\\Resources\\views\\Default\\AjouterLog.html.twig");
    }
}
