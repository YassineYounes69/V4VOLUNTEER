 ...
 */
class publication extends \ProjectBundle\Entity\publication implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ProjectBundle\\Entity\\publication' . "\0" . 'id', '' . "\0" . 'ProjectBundle\\Entity\\publication' . "\0" . 'titre', '' . "\0" . 'ProjectBundle\\Entity\\publication' . "\0" . 'contenu', '' . "\0" . 'ProjectBundle\\Entity\\publication' . "\0" . 'id_membre', '' . "\0" . 'ProjectBundle\\Entity\\publication' . "\0" . 'comments'];
        }
