...
class Evenement extends \ProjectBundle\Entity\Evenement implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ProjectBundle\\Entity\\Evenement' . "\0" . 'reference', '' . "\0" . 'ProjectBundle\\Entity\\Evenement' . "\0" . 'nom', '' . "\0" . 'ProjectBundle\\Entity\\Evenement' . "\0" . 'description', '' . "\0" . 'ProjectBundle\\Entity\\Evenement' . "\0" . 'date', '' . "\0" . 'ProjectBundle\\Entity\\Evenement' . "\0" . 'capacite', '' . "\0" . 'ProjectBundle\\Entity\\Evenement' . "\0" . 'prix', '' . "\0" . 'ProjectBundle\\Entity\\Evenement' . "\0" . 'nbParticipant', '' . "\0" . 'ProjectBundle\\Entity\\Evenement' . "\0" . 'lieu', '' . "\0" . 'ProjectBundle\\Entity\\Evenement' . "\0" . 'createur', '' . "\0" . 'ProjectBundle\\Entity\\Evenement' . "\0" . 'id_membre'];
        }
