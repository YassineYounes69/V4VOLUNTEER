...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'demandeUser', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'prenom', 'tel', 'addresse', 'codePostal', 'pays', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function getDemandeUser()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDemandeUser', []);

        return parent::getDemandeUser();
    }
    ...
    public function setDemandeUser($demandeUser)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDemandeUser', [$demandeUser]);

        return parent::setDemandeUser($demandeUser);
    }
