...
public class EvenementASSOController implements Initializable {
  ...
  @FXML
    ...
    @FXML
    public void volPushed(ActionEvent event) throws IOException {
        Parent tableViewParent = FXMLLoader.load(getClass().getResource("Volontaire.fxml"));
        Scene tableViewScene = new Scene(tableViewParent);
