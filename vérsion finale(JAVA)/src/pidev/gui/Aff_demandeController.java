...
import static pidev.entities.SmsSender.ACCOUNT_SID;
import static pidev.entities.SmsSender.AUTH_TOKEN;
 ...
 * @author ASUS-PC
 */
public class Aff_demandeController implements Initializable {
    ...
    @FXML
    private ComboBox<String> type_demande;
...
//    private Demande dddd = null;
    ...
    @FXML
    private Pane quantite;
    @FXML
    private Button confirmer_don;
    @FXML
    private TextField quant;
    @FXML
    private VBox associationcontainer;
    @FXML
    private VBox associationcontainer1;
    @FXML
    ...
    @FXML
    private Button fermer_quantite;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            List<Demande> demandes = SA.getDemandes();
...
//            background.setImage(men);
    ...
    private void afficher(List<Demande> demandes) throws SQLException {
...
//            Image log = new Image("file:/C:/Users/ASUS-PC/Desktop/22.jpg");
            ...
            name.setText(actuel.getTitreDemande());
            ...
            type.setText(actuel.getTypeDemande());
...
//              this.type_demande.setText(actuel.getTypeDemande());
                ...
                modifierr.setOnAction((ActionEvent ei) -> {
                    ...
                    if ( (!"".equals(description_demande.getText()))&&(!"".equals(titre_demande.getText()))&&(type_demande.getValue()!=null)&&(!"".equals(image_demande.getText()))  )
                            {
                    Demande nouveau;
            ...
            donner.setOnAction((ActionEvent e) -> {
                ...
                confirmer_don.setOnAction((ActionEvent ei) -> {
                    if ( (quant.getText().matches("\\d{0,7}([\\.]\\d{0,4})?"))){
                    int yy;
                    yy = Integer.parseInt(quant.getText());
                    if ( (quant.getText().matches("\\d{0,7}([\\.]\\d{0,4})?"))&&(!"".equals(quant.getText()))&&(yy < 500)&&(yy > 1) )
                    {
                    Donationn q;
//                    ServiceUser ps = new ServiceUser();
//                    ServiceDonation SD = new ServiceDonation();
...
//                    yy=15;
                    ...
                    try {
                        q = new Donationn(1, actuel.getId(), ps.getUserById(1).getId(), 0, yy, tt);
                        SD.addDonation(q);
                    } catch (SQLException ex) {
                        Logger.getLogger(Aff_demandeController.class.getName()).log(Level.SEVERE, null, ex);
                    }
...
//                    System.out.println(message.getSid());
                ...
                a.setTitle("Echec");
                a.setHeaderText(null);
                a.setContentText("La quantité doit etre comprise entre 1 et 500 !");
                a.showAndWait();
        }       }else{
                ...
                a.setTitle("Echec");
                a.setHeaderText(null);
                a.setContentText("Veuillez insèrer un entier");
                a.showAndWait();
        }       
                });
...
//            }     
    ...
    private void chercherDemande(KeyEvent event) throws SQLException {
        ...
        ArrayList<Demande> a = (ArrayList<Demande>) SA.SearchDemandes(m);
        ObservableList<Demande> obs = FXCollections.observableArrayList(a);
        afficher(obs);
    }
