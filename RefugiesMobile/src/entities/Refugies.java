...
public class Refugies {
    ...
    public Refugies(int id_ref,String pays_ref, String nom_ref, String prenom_ref, int age_ref, String gender_ref) {
        this.id_ref = id_ref;
    ...
    public Refugies( String nom_ref, String prenom_ref, int age_ref, String gender_ref) {
        this.nom_ref = nom_ref;
        this.prenom_ref = prenom_ref;
        this.age_ref = age_ref;
        this.gender_ref = gender_ref;
