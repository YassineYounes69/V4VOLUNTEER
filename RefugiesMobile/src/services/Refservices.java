...
public class Refservices {
    ...
    public ArrayList<Refugies> ShowRef() {
        ...
        //lien bundle
        con.setUrl("http://localhost/ProjetFIN/web/app_dev.php/Showref");
    ...
    public void UpdateRef(Refugies u) {
        ...
        String Url = "http://localhost/ProjetFIN/web/app_dev.php/Upref/" + u.getId_ref()+"?paysRef="+u.getPays_ref()+"&nomRef="+u.getNom_ref()+"&prenomRef="+u.getPrenom_ref()+"&ageRef="+u.getAge_ref()+"&genderRef="+u.getGender_ref();
    ...
    public void DeleteRef(Refugies ch) {
        ConnectionRequest con = new ConnectionRequest();
        String Url = "http://localhost/ProjetFIN/web/app_dev.php/Delref/" + ch.getId_ref();
        con.setUrl(Url);
    ...
    public void Addrefugies(Refugies u) 
    {
        ...
        String Url = "http://localhost/ProjetFIN/web/app_dev.php/Addref?paysRef="+u.getPays_ref()+"&nomRef="+u.getNom_ref()+"&prenomRef="+u.getPrenom_ref()+"&ageRef="+u.getAge_ref()+"&genderRef="+u.getGender_ref();// création de l'URL
    ...
    public void payer(Refugies c) {
        ConnectionRequest con = new ConnectionRequest();
        String Url = "http://localhost/ProjetFIN/web/app_dev.php/Donate";
        con.setUrl(Url);
        con.addResponseListener((e) -> {
            String str = new String(con.getResponseData());//Récupération de la réponse du serveur
    ...
    public void searchhh(Refugies refu) {
        ConnectionRequest con = new ConnectionRequest();
        String Url = "http://localhost/ProjetFIN/web/app_dev.php/lawej";
        con.setUrl(Url);
        con.addResponseListener((e) -> {
            String str = new String(con.getResponseData());//Récupération de la réponse du serveur
